            ...
            if (store[ref].img) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 col-md-3">
                                <a href="${store[ref].url}" rel="permalink">
                                    <div class="rounded-lg chulapa-overlay-img chulapa-gradient chulapa-min-h-10" style="background-image: url('${store[ref].img}')"></div>
                                </a>
                            </div>
                        </div>
                        <div class="row mt-2">
                ...
                searchitem = `
                    <article class="my-2 text-left">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <p>${store[ref].excerpt.split(" ").splice(0, 10).join(" ")}</p>
                            </div>
                        </div>
                        <hr>
                    </article>`;
